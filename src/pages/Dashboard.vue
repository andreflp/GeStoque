  ...
  <v-layout>
    <v-flex xs12 xs4 sm4>
      <v-card class="text-md-center">
        <v-card-text>
          <div>
            <h2>PRODUTOS <v-icon color="red">inbox</v-icon></h2>
            <h2><animate-number 
              v-if="numStart === true"
              ref="myNum1"
              mode="manual"
    ...
    <v-flex xs12 xs4 sm4 style="margin-left: 20px; height: 200px" >
      <v-card class="text-md-center ">
        <v-card-text>
          <div>
            <h2>FORNECEDORES <v-icon color="primary">business_center</v-icon></h2>
            <h2 >
              <animate-number 
              v-if="numStart === true"
              ref="myNum2"
    ...
    <v-flex  xs4 sm4 style="margin-left: 20px;">
      <v-card class="text-md-center">
        <v-card-text>
          <span>
            <h2>MOVIMENTAÇÕES <v-icon color="teal accent-4">compare_arrows</v-icon></h2>
            <h3>
              Entradas: 
              <animate-number 
              v-if="numStart === true"
