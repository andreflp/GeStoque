<template>
  <v-navigation-drawer app :permanent="drawer">
    <v-toolbar flat color="teal accent-4" dark>
      <v-list>
        <v-list-tile>
          <v-list-tile-title class="title">GeStoque</v-list-tile-title>
        </v-list-tile>
      </v-list>
    </v-toolbar>
    ...
    <v-list dense class="pt-0">
      ...
      <v-list-group prepend-icon="person_add" false>
        ...
        <v-list-tile v-for="cadastro in cadastros" :key="cadastro.title" :to="cadastro.route">
          <v-list-tile-action>
